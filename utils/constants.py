...
API_PERMISSION_ERROR_CODE_33 = 33
MAX_NUMBER_TRY = 3
...
# query strings
SQL_GET_DATA_USER_BUSINESS_DISCOVERY = "select * from %s.users_business_discovery limit 9999"%KEYSPACE_NAME
...
RS_TIME_SLEEP_GET_NEW_DATA = 86400
